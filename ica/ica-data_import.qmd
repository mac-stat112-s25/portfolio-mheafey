...
The data was sourced from TMDb (The Movie Database), and was uploaded to kaggle by chuan. 
...
```{r}
library(tidyverse)
imdb_messy <- read_csv("~/Documents/GitHub/portfolio-mheafey/data/imdb_5000_messy.csv")
```
...
Minimum, median, maximum, quartiles, NAs.

-   What type of info is provided on categorical variables?

Number of entries for the top values, NAs.

-   What stands out to you in these summaries? Is there anything you'd need to clean before using this data?

I'd probably clean up some of the NAs, especially with the quantitative variables.
...
There's three different names for the value "color", and two different names for the value "black and white"
...
color (30), Color (4755), and COLOR (30). 
...
It's important to save a copy of the original data in case you want to go back on an edit you've made. Also because you took it from someone online you don't want to alter their dataset and say it was like that when you got it.
...
They all seem to be documentaries, so they don't have "actors"
...
I just removed the NAs for the purpose of finding the average, I didn't have to create a new dataset without them.
...
Got rid of every data point, there are 3756 data points left.

-   In what situations might this function be a good idea?

If you absoutely need every data point to be complete I guess

-   In what situations might this function be a bad idea?

Most of them since it's such a drastic action to take.
...
5010 movies remain, which keeps a lot that would have been removed in part b.
