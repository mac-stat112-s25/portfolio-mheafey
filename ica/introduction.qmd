...
- In the console, type \`?r
ep\` and press return/enter.
...
- Stop at the \*\*Examples\*\* at the bottom.
Perhaps the most useful section, this is where a function's functionality is demonstrated!
Try out a couple of the provided examples in your console.
...
- Check out the \*\*Environment\*\* pane of RStudio.
What do you observe there and when might this be helpful?
- Similarly, check out the \*\*History\*\* pane of RStudio.
What do you observe there and when might this be helpful?
...
It assumes an order of "x" then "times"
rep(2, 5)
rep(5, 2)
