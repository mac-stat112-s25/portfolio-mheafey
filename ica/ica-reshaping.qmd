...
It seems as if reaction time increases over days with minimal sleep, though not everyone has the same progression.
...
ggplot(billboard, aes(y = wk2, x = wk1)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, color = "turquoise")
...
nov_1999 |>
  pivot_longer(starts_with("wk"), values_to = "rank", names_to = "week", names_prefix = ("wk")) |>
